...
const comparisons = [
  { feature: "iSpring Learn", price: "от 2 700 ₽/пользователь", modules: "Есть", ai: "Нет", bitrix: "Нет" },
  ...
  { feature: "KDB (IT Solution)", price: "от 990 ₽/месяц", modules: "Есть", ai: "Нет", bitrix: "Встроен" },
  { feature: "Умная база знаний", price: "от 1 990 ₽/месяц", modules: "Неогр.", ai: "Полный", bitrix: "Встроен", highlight: true },
];
